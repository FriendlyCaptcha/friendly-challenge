...
> This is documentation for Friendly Captcha **v1**.
>
> You can [learn more](https://developer.friendlycaptcha.com/docs/v2/versions) about v1 and v2, or you can switch to the [Friendly Captcha v2 Developer Hub](https://developer.friendlycaptcha.com).
