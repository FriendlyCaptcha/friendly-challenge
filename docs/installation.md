...
```html
<!-- from unpkg -->
<script type="module" src="https://unpkg.com/friendly-challenge@0.7.0/widget.module.min.js" async defer></script>
<script nomodule src="https://unpkg.com/friendly-challenge@0.7.0/widget.min.js" async defer></script>
...
> Make sure to always import a specific version (e.g. `friendly-challenge@0.7.0`), then you can be sure that the script you import and integrate with your website doesn't change unexpectedly.
