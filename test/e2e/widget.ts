...
module.exports = {
  "FriendlyCaptcha widget works in the happy case": function (client: NightwatchBrowser) {
    client
      ...
      .expect.element("input[name=frc-captcha-solution]")
      .value.to.equal(".UNSTARTED");
    ...
    client
      ...
      .getAttribute(".frc-text", "title", function (s) {
        console.log(s.value);
      })
      .assert.elementPresent("#frc-captcha-done-callback-generated-element")
      .expect.element("input[name=frc-captcha-solution]")
      .value.to.match(/[a-f0-9]{32}\.[a-zA-Z0-9/+=]*\.[a-zA-Z0-9/+=]*\.[a-zA-Z0-9/+=]{4}/);
